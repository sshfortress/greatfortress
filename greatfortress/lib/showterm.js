/**
 * initially taken from https://github.com/ConradIrwin/showterm.io
 * license at a time: https://github.com/ConradIrwin/showterm.io/blob/dd8791b2b6162b277d65b77574fdf9f282b01509/LICENSE.MIT
 */
...
$.fn.showterm = function (options) {
    ...
    help_html = "<h3> Use following keyboard shortcuts for navigation: </h2> " +
        ...
        "</ul>"
    $that.html('<div class="showterm-controls"><span class="showterm-logo">playback</span> <div class="showterm-slider"></div><a href="#slow">slow</a><a href="#fast">fast</a><a href="#stop">stop</a><a id="help_link" href="javascript:void">?</a><a id="fullscreen_btn" href="javascript:void" style="text-decoration:none">[ ]</a></div><div id="help_dialog">' + help_html + '</div>');
    $that.append($('<style>').text('.showterm-controls a { padding-right: 10px;} .showterm-controls { opacity: 0.8; padding: 10px; background: rgba(255, 255, 255, 0.2); position: absolute; right: 0; bottom: 0; } .showterm-controls .showterm-slider { height: 5px; width: 200px; margin-right: 10px; margin-left: 10px; display: inline-block;} .showterm-controls .showterm-slider a { height: 13px; } .showterm-controls .showterm-logo-link {  text-decoration: none;} .showterm-logo { font-weight: bold;}'));
